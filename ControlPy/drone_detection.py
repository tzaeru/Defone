"""
Drone detection using a YOLOv8-based model trained for drone detection.
Uses the doguilmak/Drone-Detection-YOLOv8x weights from Hugging Face.
"""
...
def detect_drones(
    ...
    Args:
        ...
        conf: Confidence threshold (higher = fewer false positives, e.g. branches).
        iou: IoU threshold for NMS.
        imgsz: Input size for the model; larger (e.g. 960) helps small/head-on drones.
        augment: If True, use test-time augmentation (slower, often better recall).
